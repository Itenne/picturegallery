...
resource "azurerm_storage_account" "sg1" { 
 name      =  "itenne01234" #add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
...
name    =  "serverformationiac" #add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
...
resource "azurerm_mysql_flexible_database" "mysqldb1-Sandbox_ELA" { 
 name    =  "mysqldb1-iac" 
 resource_group_name =  var.rg_name
 server_name   =  azurerm_mysql_flexible_server.serverformation1.name
 charset    =  "utf8" 
